...
<!-- Page Content
  ...
  <section class="hero">
    <div class="container text-center">
      <div class="row">
        <div class="col-md-12">
          <a class="hero-brand" href="{{URL::to('/')}}" title="Home"><img alt="Bell Logo" src="{{URL::to('img/logo.png')}}"></a>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <a class="btn btn-full" href="{{URL::to('#about')}}">Get Started Now</a>
      </div>
    </div>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="{{URL::to('/')}}"><img src="{{URL::to('img/logo-nav.png')}}" alt="" title="" /></img></a>
      ...
      <nav class="nav social-nav pull-right d-none d-lg-inline">
        <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-linkedin"></i></a> <a href="mailto:info@dhcd.in"><i class="fa fa-envelope"></i></a>
      </nav>
    </div>
  </header>
  <!-- #header -->
  ...
  <div class="block bg-primary block-pd-lg block-bg-overlay text-center" data-bg-img="{{URL::to('img/parallax-bg.jpg')}}" data-settings='{"stellar-background-ratio": 0.6}' data-toggle="parallax-bg">
    <h2>
    ...
    <img alt="Bell - A perfect theme" class="gadgets-img hidden-md-down" src="{{URL::to('img/gadgets.png')}}">
  </div>
  <!-- /Parallax -->
  ...
  <section class="portfolio" id="portfolio">
    ...
    <div class="portfolio-grid">
      <div class="row">
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{URL::to('img/porf-1.jpg')}}">
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{URL::to('img/porf-2.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{URL::to('img/porf-3.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{URL::to('img/porf-4.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
      ...
      <div class="row">
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{URL::to('img/porf-5.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{URL::to('img/porf-6.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{URL::to('img/porf-7.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{URL::to('img/porf-8.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
  ...
  <section class="team" id="team">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-3 col-xs-6">
          <div class="card card-block">
            <a href="#"><img alt="" class="team-img" src="{{URL::to('img/team-1.jpg')}}">
      ...
      <div class="col-sm-3 col-xs-6">
        <div class="card card-block">
          <a href="#"><img alt="" class="team-img" src="{{URL::to('img/team-2.jpg')}}">
              <div class="card-title-wrap">
                <span class="card-title">Sergio Fez</span> <span class="card-text">Art Director</span>
              </div>
    ...
    <div class="col-sm-3 col-xs-6">
      <div class="card card-block">
        <a href="#"><img alt="" class="team-img" src="{{URL::to('img/team-3.jpg')}}">
              <div class="card-title-wrap">
                <span class="card-title">Sergio Fez</span> <span class="card-text">Art Director</span>
              </div>
    ...
    <div class="col-sm-3 col-xs-6">
      <div class="card card-block">
        <a href="#"><img alt="" class="team-img" src="{{URL::to('img/team-4.jpg')}}">
              <div class="card-title-wrap">
                <span class="card-title">Sergio Fez</span> <span class="card-text">Art Director</span>
              </div>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="form">
            <form action="{{URL::to('/contact')}}" method="post" role="form" class="contactForm" enctype="multipart/form-data">
              @csrf
              <div class="form-group">
                <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" maxlength="30" minlength="2" required="required" value="{{ old('name') }}" />
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <select id="subject" name="subject" class="form-control" required="required">
                  ...
                  <option value="Re-construction">Re-construction</option>
